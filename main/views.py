...
def index(request):
    ...
    """
    auth_url = " https://www.openhumans.org/direct-sharing/projects/oauth2/authorize/?client_id=dOjrWikIkoZnh2pOJAiOm0a1XPWHAPIVgRBswH5y&response_type=code&redirect_uri=http%3A%2F%2Fautisticaexperiences-prototype.herokuapp.com%2Fopenhumans%2Fcomplete" #OpenHumansMember.get_auth_url()
